...
Adafruit_SH1106 <SCREEN_WIDTH, SCREEN_HEIGHT> display;

// FPS control
double delta = 1;
uint32_t lastFrameTime = 0;

#ifdef OPTIMIZE_SH1106
// Optimizations for SH1106 handles buffer directly
uint8_t *display_buf;
#endif
...
void setupDisplay() {
  ...
  if (!display.begin(SH1106_SWITCHCAPVCC, 0x3C)) { // Fixed from 0x3D
